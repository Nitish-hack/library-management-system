...
import { getAllBook, filterBook, deleteOneBook } from "../actions/book_action"
...
const AllBook = () => {
    ...
    const handleDeleteBook = (bookName) => {
        // Dispatch the deleteOneBook action with the book name
        dispatch(deleteOneBook(bookName));
        alert("book deleted successfully, refresh!");
    ...
    return (
        <div>
            <div className="col-md-10 m-auto" >
                <h3 className='text-center bg-info p-2' style={{ fontFamily: "sans-serif", }}>All AVAILABLE BOOK'S IN LIBARY</h3>
                <br />
            ...
            {!books.length ?
                <div style={{ marginLeft: "25%", marginTop: "5%" }}>
                    ...
                    <h1>No Books added in system!</h1>
                </div>
                                            ...
                                            <td>
                                                ...
                                                {currentUser.user.isAdmin && (
                                                    <FunctionContainer>
                                                        ...
                                                        <button className="btn btn-danger" onClick={() => handleDeleteBook(book.title)}>Delete</button>

                                                        {/* <i className='fa fa-trash ' style={{ cursor: "pointer" }}  ></i>
                                                        <i className='fa fa-trash ' style={{ cursor: "pointer" }} onClick={() => handleDeleteBook(book.title)} ></i> */}
